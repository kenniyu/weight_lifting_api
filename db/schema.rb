...
ActiveRecord::Schema.define(version: 20160320182340) do
  ...
  add_index "exercise_sets", ["routine_session_id"], name: "index_exercise_sets_on_routine_session_id"
  ...
  add_index "routine_sessions", ["routine_id"], name: "index_routine_sessions_on_routine_id"
